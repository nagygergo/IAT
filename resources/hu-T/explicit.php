    ...
    <div class="card">
        <div class="card-content row">
            <div class="col m10 offset-m1">
                <p>
                <h5 class="center-align" style="color:red">A teszt befejezéséhez minden kérdésnél meg kell jelölnöd válaszlehetőséget! </h5>
                <ol>
                    <li> Próbáld mindíg a saját tapasztalataidhoz, véleményedhez  legközelebb álló lehetőséget választani! </li>
                     <li>Amennyiben az adatfelvételi lappal vagy a teszttel kapcsolatban kiegészítésed, kérdésed lenne, kérjük írd be a lap alján található "Megjegyzések" mezőbe!</li>
                     <li><b> A válaszokon ne gondolkodj sokáig! </b>Az első, automatikus válaszaidra vagyunk kíváncsiak. </li>
...
<div class="container">
    <form id="explicit" action="router.php" onsubmit="return checkForm()" method="post">
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">1. Viselsz szemüveget vagy fülbevalót?</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">2. Használsz sminket?</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">3. Van-e tetoválásod, kozmetikai tetoválásod, piercinged? (Egyszerre többet is bejelölhetsz)</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">5. Mennyire meghatározó számodra saját arcod önértékelésed szempontjából?</div>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">6. A hibátlan arcú személyekkel kapcsolatos érzelmeidet hogyan értékelnéd az alábbi skálán??</div>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">7.Érte-e már valaha jelentősebb sérülés az arcodat? (Egyszerre többet is bejelölhetsz)</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">8.Van-e mások számára is észrevehető elváltozás, szépséghiba az arcodon? (Egyszerre többet is bejelölhetsz)</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">9. Mennyire érzel együtt azokkal a személyekkel, akik maradandó sérülést szenvedtek az arcukon?</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">10.Ismersz-e olyan személyt, akinek az arcán esztétikai hiba, sérülés van (pl. heg, pigmentfolt, égési sérülés)? (Egyszerre többet is bejelölhetsz)</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">10.2. Ha az előző kérdésre igennel válaszoltál, milyen személyes tapasztalataid érzéseid vannak az adott személlyel kapcsolatban? (Egyszerre többet is bejelölhetsz.)</div>
                    <p>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">11. Milyen jellegű legközelebbi viszonyt fogadnál el szívesen, a felsorolt tulajdonságokkal rendelkező személlyel?
                    Jelöld be a legközelebbi viszonynak megfelelő számot, minden jellemzőnél csak egyet!</div>
                    <div class="row">
                        <div class="col m6">
                            <ol>
                        ...
                        <div class="row">
                            <div class="col m8 offset-m1">
                                <table class="" style="border-spacing: 100px;">
                                    ...
                                    <tr>
                                        <td>Roma (cigány) </td><?php RadioRange9("roma",6, 12);?>
                                    </tr>
                                    <tr>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">12. Milyen mértékben határozza meg egy adott személyről kialakított benyomásodat annak arcának szépsége?</div>
        ...
        <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">13. A környezetemben lévő emberekhez képest az én arcom:</div>
                    <p>
      ...
      <div class="question-wrapper">
            <div class="card z-depth-0">
                <div class="card-content">
                    <div class="card-title">14. Mennyire pozitív vagy negatív érzelmeid vannak a sérült arcú személyekkel kapcsolatban?</div>
